            ...
            <div className="bg-white w-[700px] rounded-xl p-8 border-4 border-gray-300 space-y-4">
                ...
                <div className="flex items-center">
                    ...
                    <>
                        ...
                        <button onClick={() => showPopup(index)} className="flex justify-center rounded-3xl border-4 border-gray-300 pt-0.5 pb-0.5 pl-2 pr-2 text-s ml-4" ><CircleHelpIcon />特性</button>
                    </>
